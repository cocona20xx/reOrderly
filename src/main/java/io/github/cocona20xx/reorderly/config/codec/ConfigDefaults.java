...
final class ConfigDefaults {
    ...
    static final int backgroundHeight = 6;
    static final int barHeight = 4;
    static final int plateSize = 25;
    static final int plateSizeBoss = 50;
    static final boolean showAttributes = true;
    static final boolean showArmor = true;
    static final boolean showGroupArmor = true;
    static final boolean doColorByType = false;
    static final int hpTextHeight = 14;
    static final boolean showMaxHp = true;
    static final boolean showCurrentHp = true;
    static final boolean showPercentage = true;
    static final boolean showOnPlayers = true;
    static final boolean showOnBosses = true;
    static final boolean showFocusedOnly = false;
