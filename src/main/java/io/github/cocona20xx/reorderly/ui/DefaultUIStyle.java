...
public class DefaultUIStyle extends SimpleUIStyle {
    ...
    private static final Identifier TEXTURE = new Identifier(ReOrderlyMod.MODID, "textures/ui/default_health_bar.png");
    ...
    @Override
    protected void render(MatrixStack matrices, VertexConsumerProvider.Immediate immediate, Camera camera, ReOrderlyConfigAccessor config, LivingEntity entity, int light, ItemStack icon, boolean boss) {
